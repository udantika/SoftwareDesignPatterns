                ...
                <Tab.List className="-mb-px flex space-x-8 px-4">
                  {navigation.categories.map((category) => (
                    <Tab
                      ...
                      className={({ selected }) =>
                        selected
                          ? 'flex-1 whitespace-nowrap border-b-2 border-indigo-600 py-4 px-1 text-base font-medium text-indigo-600'
                          : 'flex-1 whitespace-nowrap border-b-2 border-transparent py-4 px-1 text-base font-medium text-gray-900'
                      }
                    >
                      {category.name}
                    </Tab>
                      ...
                      {({ open }) => (
                        <>
                          <div className="relative flex">
                            <Popover.Button
                              className={open ? 'text-indigo-600' : 'text-gray-700 hover:text-gray-800'}
